...
conducta_nucleo = df.groupby("NUCLEO_FAMILIAR")["NOTA"]
conducta_zona = df.groupby("ZONA")["NOTA"]
...
plt.title("Estadísticas de Notas por Núcleo Familiar")
...
plt.title("Estadísticas de Notas por Zona de Vivienda")
plt.xlabel("Zona")
plt.ylabel("Valor")
plt.show()
# --------------------------------- #